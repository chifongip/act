...
# record fold towel
python3 pnp_record_sim_episodes.py --task_name sim_towel --dataset_dir demo/sim_towel_scripted_cotrain_2 --num_episodes 50 

# visualize sim data
# python3 pnp_visualize_episodes.py --dataset_dir demo/sim_towel_scripted_cotrain --episode_idx 0
