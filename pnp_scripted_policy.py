...
from pnp_constants import SIM_TASK_CONFIGS
...
class PnPPolicy(BasePolicy):
    ...
    def generate_trajectory(self, ts_first):
        ...
        self.left_trajectory = [
            ...
            {"t": 400, "xyz": init_mocap_pose_left[:3], "quat": init_mocap_pose_left[3:], "gripper": 0},
        ...
        self.right_trajectory = [
            ...
            {"t": 280, "xyz": bowl_xyz + np.array([0, 0, 0.2]), "quat": gripper_pick_quat.elements, "gripper": 0},  # approach to the bowl
            {"t": 300, "xyz": bowl_xyz + np.array([0, 0, 0.1]), "quat": gripper_pick_quat.elements, "gripper": 0},  # go down
            {"t": 320, "xyz": bowl_xyz + np.array([0, 0, 0.1]), "quat": gripper_pick_quat.elements, "gripper": 1},  # open gripper 
            {"t": 360, "xyz": bowl_xyz + np.array([0, 0, 0.2]), "quat": gripper_pick_quat.elements, "gripper": 1},  # go up
            {"t": 400, "xyz": bowl_xyz + np.array([0, 0, 0.2]), "quat": gripper_pick_quat.elements, "gripper": 1},  # stay
